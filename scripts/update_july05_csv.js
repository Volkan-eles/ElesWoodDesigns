/**
 * update_july05_csv.js
 * Imports newly added products and fully synchronizes/updates existing products'
...
for (const row of dataRows) {
  ...
  if (existingTitleMap.has(titleLower)) {
    ...
    // 2. Update Images & Thumbnails (Ensuring all listing images are present)
    ...
    // Hardcode matching Etsy listing URL provided by user
    let etsyUrl = '';
    if (titleLower.includes('circular pergola') || titleLower.includes('porch swing')) {
      etsyUrl = 'https://www.etsy.com/listing/4532889137/diy-circular-pergola-porch-swing-plans';
    }
