...
export async function GET() {
  ...
  const items = products.map((product) => {
    ...
    const isPartyPrintable = product.category === 'Digital' && (product.slug.includes('kentucky-derby') || product.slug.includes('party') || product.slug.includes('game') || product.slug.includes('betting') || product.slug.includes('cards') || product.slug.includes('mothers-day') || product.slug.includes('handprint') || product.slug.includes('craft') || product.slug.includes('keepsake') || product.slug.includes('mahjong'));
